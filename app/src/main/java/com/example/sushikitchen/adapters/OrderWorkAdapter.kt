...
class OrderWorkAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var mOrderDialogList: ArrayList<OrderModel> = ArrayList()

    fun setupWorkOrder(orderDialogList: ArrayList<OrderModel>){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView  = layoutInflater.inflate(R.layout.item_menu,parent,false)
    ...
    class BasketViewHoldel(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun bind (orderModel: OrderModel){
            dish.text = "${orderModel.os}"
            amount.text = "${orderModel.os}"
